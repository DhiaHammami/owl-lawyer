<?php
include 'Config.php';		
 $sql = "UPDATE case SET num_case='$_POST[num_case]',date_accept='$_POST[date_accept]',degree='$_POST[degree]',phase='$_POST[phase]',place='$_POST[place],tribunal='$_POST[tribunal]',juge	='$_POST[juge]' ,date_next_session	='$_POST[date_next_session]' ,remarque	='$_POST[remarque]'WHERE id_case='$_POST[id_case]' ";
mysqli_query($db, $sql);
header('Location: list_case.php');     

//On teste si le formulaire a été soumis
 $sqll="SELECT * FROM case  WHERE id_case='$_REQUEST[id_case]' ";	
						...
						<div class="col-xl-12 col-lg-12 col-md-12	 col-sm-12 col-12">
							<div class="card h-100">
								<div class="card-header">
									<div class="card-title">  تغيير القضية
									</div>
								</div>
								<div class="card-body">
								<form action="update_case.php" method="POST">
									...
									<div class="row gutters">
										...
										<div class="form-group">
												<label for="number">عدد القضية	</label>
												<input type="number" class="form-control" name="num_case" value="<?php echo (isset($row['num_case'])) ? $row['num_case'] : ''; ?>">
