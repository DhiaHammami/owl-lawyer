<?php
include 'Config.php';		
 $sql = "UPDATE payement SET date_pay='$_POST[date_pay]',montant='$_POST[montant]',type_pay	='$_POST[type_pay]',banque='$_POST[banque]',remarque='$_POST[remarque],tribunal=' ";
mysqli_query($db, $sql);
						...
						<div class="col-xl-12 col-lg-12 col-md-12	 col-sm-12 col-12">
							<div class="card h-100">
								<div class="card-header">
									<div class="card-title">  تغيير الدفوعات
									</div>
								</div>
								<div class="card-body">
								<form action="update_payement.php" method="POST">
									...
									<div class="row gutters">
										...
										<div class="form-group">
											...
											<div class="form-group">
												<label for="date">كيفية الدفع 	</label>
												<input type="date" class="form-control" id="type_pay" name="type_pay"  value="<?php echo $row["type_pay"]; ?>">
											</div>
											<div class="form-group">
