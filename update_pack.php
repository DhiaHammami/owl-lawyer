...
if((isset($_POST['nom_pack'])) && (isset($_POST['prix'])))
 ...
 $sql = "UPDATE pack_avocat SET nom_pack='$_POST[nom_pack]',prix='$_POST[prix]',nb_jours='$_POST[nb_jours]' WHERE id='$_POST[id]' ";
mysqli_query($db, $sql);
header('Location: list_pack.php');     
}
//On teste si le formulaire a été soumis
 $sqll="SELECT * FROM pack_avocat  WHERE id='$_REQUEST[id]' ";	
						...
						<div class="col-xl-12 col-lg-12 col-md-9	 col-sm-12 col-12">
							<div class="card h-100">
								<div class="card-header">
									<div class="card-title">  تغيير الباقة
									</div>
								</div>
								<div class="card-body">
								<form action="update_pack.php" method="POST">
									<input type="hidden" name="id" value="<?php echo $_REQUEST['id'] ?>"/>	
									<div class="row gutters">

										<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
										<div class="form-group">
												<label for="fullName">إسم الباقة</label>
												<input type="text" class="form-control" name="nom_pack" value="<?php echo (isset($row['nom_pack'])) ? $row['nom_pack'] : ''; ?>">
												
											</div>
											<div class="form-group">
												<label for="fullname">ثمن الباقة</label>
												<input type="fullname" class="form-control" id="prix"name="prix"  value="<?php echo $row["prix"]; ?>">
												
											</div>
											<div class="form-group">
												<label for="phone">مدة الصلوحية</label>
												<input type="text" class="form-control" id="nb_jours" name="nb_jours"  value="<?php echo $row["nb_jours"]; ?>">
											</div>
